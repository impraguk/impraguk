...
async def on_member_join(member):
    newUserMessage = (":speech_balloon:**Throm'ka, grunt {}! Da boss, {}, will get lat sorted wiv roles agh all dat skah. If lat wanna interact wiv me, do:** _!help_".format(member.mention, <@Wargoth>))
